...
mongoose.connect('mongodb+srv://anshul:anshul21@shoppingportal-mdtac.mongodb.net/test?retryWrites=true&w=majority', { useUnifiedTopology: true, useCreateIndex: true, useNewUrlParser: true }, (err, shoppingportal) => {
